...
import com.platzi.JDevmarket.domain.dto.AuthenticationRequest;
import com.platzi.JDevmarket.domain.dto.AuthenticationResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
        try{
            ...
            String jwt = jwtUtil.generateWebToken(userDetails);
